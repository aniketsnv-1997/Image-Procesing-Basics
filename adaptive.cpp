...
using namespace cv;
 ...
 Mat global_thresholding;
  ...
  imwrite("grayimg.png", gray_image);
  imwrite("globalThreshold.png", global_thresholding);
  imwrite("adaptiveGaussian.png", adaptive_gaussian);
  imwrite("adaptiveMean.png", adaptive_mean);
